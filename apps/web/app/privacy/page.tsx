        ...
        <div className="min-h-screen bg-void text-text-main py-16 font-mono relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                <div className="mb-12 border-b border-border-std pb-6">
                    <h1 className="text-4xl font-display font-bold text-text-main uppercase tracking-widest mb-2">Privacy Policy</h1>
                ...
                <div className="space-y-8 text-sm leading-relaxed text-text-dim">
                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">1. Information We Collect</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">2. How We Use Your Information</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">3. Data Security</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">4. Third-Party Services</h2>
                        <p>We may employ third-party companies and individuals due to the following reasons: to facilitate our Service; to provide the Service on our behalf; to perform Service-related services; or to assist us in analyzing how our Service is used. These third parties have access to your Personal Data only to perform these tasks on our behalf and are obligated not to disclose or use it for any other purpose.</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">5. Contact Us</h2>
