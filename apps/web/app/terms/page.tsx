        ...
        <div className="min-h-screen bg-void text-text-main py-16 font-mono relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                <div className="mb-12 border-b border-border-std pb-6">
                    <h1 className="text-4xl font-display font-bold text-white uppercase tracking-widest mb-2">Terms & Conditions</h1>
                ...
                <div className="space-y-8 text-sm leading-relaxed text-text-dim">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white uppercase mb-4 border-l-2 border-cyan pl-3">2. AI Generation & Content Policy</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white uppercase mb-4 border-l-2 border-cyan pl-3">3. Payments & AI Credits</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white uppercase mb-4 border-l-2 border-cyan pl-3">4. Intellectual Property</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-white uppercase mb-4 border-l-2 border-cyan pl-3">5. Modification of Terms</h2>
