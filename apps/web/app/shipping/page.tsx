        ...
        <div className="min-h-screen bg-void text-text-main py-16 font-mono relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6 relative z-10">
                <div className="mb-12 border-b border-border-std pb-6">
                    <h1 className="text-4xl font-display font-bold text-text-main uppercase tracking-widest mb-2">Shipping Policy</h1>
                ...
                <div className="space-y-8 text-sm leading-relaxed text-text-dim">
                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">1. Order Processing Time</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">2. Shipping Timelines</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">3. Shipping Rates</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">4. Tracking Your Order</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-text-main uppercase mb-4 border-l-2 border-cyan pl-3">5. Delays & Issues</h2>
